...
class graph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "graph")
        ...
        self.osmosdr_source_0.set_sample_rate(3E6)
        self.osmosdr_source_0.set_center_freq(1961E6, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_waterfall_sink_x_0.set_frequency_range(2.4E9, self.samp_rate)
